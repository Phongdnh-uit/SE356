...
public record AssignDriverCommand(String orderId, String driverId, String depotId)
  ...
  public AssignDriverCommand {
    ...
    if (depotId == null || depotId.isBlank()) {
      errors.add(
          new FieldError(
              "depotId", CommonErrorCode.FIELD_REQUIRED.getMessageKey(), new Object[] {"depotId"}));
    }
    if (!errors.isEmpty()) {
